...
#app.config['MYSQL_DATABASE_HOST'] = "phonebook-rds.cp7pqf4qenlb.us-east-1.rds.amazonaws.com"
...
def find_records():
    if request.method == 'POST':
        ...
        return render_template('index.html', show_result=False, developer_name='Andy')
